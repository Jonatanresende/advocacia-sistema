      ...
      <Card noPadding className="shadow-none !border-[var(--border-card)] rounded-[14px] overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-16 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-[15px] font-semibold text-[var(--text-main)] font-display mb-1">Nenhum cliente encontrado</h3>
            <p className="text-[var(--text-muted)] text-[13px]">Os clientes aparecerão aqui quando um lead for marcado como compareceu.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-[var(--border-card)] bg-[var(--bg-base)]/50">
                  <th className="p-4 text-[11px] font-semibold text-[var(--text-muted)] uppercase tracking-wider">Primeira Visita</th>
                  <th className="p-4 text-[11px] font-semibold text-[var(--text-muted)] uppercase tracking-wider">Início do Atendimento</th>
                  ...
                  <th className="p-4 text-[11px] font-semibold text-[var(--text-muted)] uppercase tracking-wider">Motivo Inicial</th>
                </tr>
              </thead>
                  ...
                  >
                    ...
                    <td className="p-4 text-[13px] font-semibold text-[var(--text-main)]">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-[8px] bg-[var(--success)]/10 text-[var(--success)] flex items-center justify-center shrink-0">
                          <UserCheck size={15} />
                        </div>
